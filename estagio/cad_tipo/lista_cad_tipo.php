  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="row">
        ...
        <div class="col-md-3"><a href="index.php?url=cad_tipo/lista_cad_tipo&page=lista_estagio"><button  style="font-size: 20px; color: white;" class="btn verde-btn "><i class="fa fa-graduation-cap" aria-hidden="true"></i>  Tipo Estágio</button></a></div>
      </div> <br>
