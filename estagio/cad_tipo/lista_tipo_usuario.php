...
<div class="container"><br><br>
 ...
 <a class="btn btn-success" data-toggle='tooltip' title="Editar" href="index.php?url=cad_tipo/lista_cad_tipo&page=editar_perfil&id=<?= utf8_encode($reg->id_perfil)?>" ><i class="glyphicon glyphicon-pencil"></i></a>
