                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="nome_estagiario" type="text" class="form-control" id="nome" placeholder="Nome"  value="<?php echo utf8_encode($reg->nome)?>" style="text-transform:uppercase;">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Observação de Encaminhamento</h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                        ...
                                        <td> 
<a class="btn btn-success" data-toggle='tooltip' target="_blank" title='Editar' href="index.php?url=historico/editar_historico&id_rem=<?=$rem->id_remocao?>"><i class="glyphicon glyphicon-pencil"></i></a>
</td>
                                    </tr>
