...
if(!empty($_GET['id_cad'])){
    ...
    $del6 = new manipulaData();
    $del6->setTable("tb_remocao");
    $del6->setCampoId('id_cad');
    $del6->setValorId($_GET['id_cad']);
    $del6->delete();

    $del7 = new manipulaData();
    $del7->setTable("tb_obs");
    $del7->setCampoId('id_cad');
    $del7->setValorId($_GET['id_cad']);
    $del7->delete();
